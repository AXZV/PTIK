...
<html>
<head>
	<title> DAFTAR PENCARIAN AKADEMIK </title>
<style>
	*{
		margin:0px;
		padding: 0px;
...
<body>
	...
	<center>
	<a class="back" href="menampilkan_data_prestasi_akademik.php"><img src="icon/back.png" height="30px"> </a>
	<table border="0" align="center">
		<tr>
			<th class="th2">
				<form class="fcari" action="pencarian_prestasi_akademik.php" method="post">
...
if ($tcari)
{
	if ($icari != "") 
	{
		$hasil=mysqli_query($connection,"SELECT * FROM akademik where nim like '%$icari%' or nama like '%$icari%' or kegiatan like '%$icari%' or tingkat like '%$icari%' or prestasi like '%$icari%' ") or die (mysqli_error($connection));
	}
	else
	{
		$hasil=mysqli_query($connection,"SELECT * FROM akademik") or die (mysqli_error());
	}
}
else
{
