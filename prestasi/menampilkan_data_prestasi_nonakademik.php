<?php
include 'koneksi.php';
$hasil=mysqli_query($connection,'SELECT * FROM nonakademik');
?>
<!DOCTYPE html>
<html>
<head>
	<title> DAFTAR PRESTASI MAHASISWA </title>
		<title> DAFTAR PRESTASI NONAKADEMIK MAHASISWA </title>
<style>
	table
	{
		width: 90%;
...
<body>
	...
	<table border="0" align="center">
		<tr>
			<th class="th2">
				<form class="fcari" action="pencarian_prestasi_nonakademik.php" method="post" enctype="multipart/form-data">
