<!DOCTYPE html>
	...
	<a class="btn btn-primary" href="kelola_prestasi_akademik.php" id="input">Semua Prestasi</a>
		<form method="POST">
		<table class="table-hover" border="1" cellpadding="0" cellspacing="1" width="1000" cellspacing="4">
			...
			<?php
				...
				$sql="SELECT * FROM akademik WHERE nim LIKE '%$pencarian%' OR nama LIKE '%$pencarian%' OR tingkat LIKE '%$pencarian%' OR prestasi LIKE '%$pencarian%' ";
