<!DOCTYPE html>
	...
	<center>
	<form action="kelola_pencarian_prestasi_non_akademik.php" method="POST">
	<div class="pencarian">
	...
	<a class="btn btn-primary" href="kelola_prestasi_non_akademik.php" id="input">Semua Prestasi</a>
		<form method="POST">
		<table class="table-hover" border="1" cellpadding="0" cellspacing="1" width="1000" cellspacing="4">
			...
			<?php
				...
				$sql="SELECT * FROM nonakademik WHERE nim LIKE '%$pencarian%' OR nama LIKE '%$pencarian%' OR tingkat LIKE '%$pencarian%' OR prestasi LIKE '%$pencarian%' ";
			...
			<tr>
				...
				<td width="170"> <a class="btn btn-warning btn-xs" href="kelola_edit_prestasi_non_akademik.php?id=<?php echo $rows['id'] ?>">Edit</a>  
					<a class="btn btn-danger btn-xs" href="proses_hapus_prestasi_non_akademik.php?id=<?php echo $rows['id'] ?>" onClick="alert('Data behasil dihapus')">Delete</a></td>
			</tr>
			<?php
