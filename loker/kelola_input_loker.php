...
<body>
	...
	<?php
				...
				$sql = "SELECT * FROM loker WHERE no ='$id'";
	...
	?>
		<tr>
			<td>
				...
				<input type="text" name="no_id" value="<?= $rows['no']; ?>" hidden>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<input type="date" name="tgl_upload" class="form-control input-sm" required value="<?= $rows['tgl_upload']; ?>">
			</td>
		</tr>
		<tr>
			<td>
				<input type="date" name="tgl_acc" value="<?php echo date("Y-m-d") ?>" hidden>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td colspan="3" style="float:right;">
				<a href="kelola_loker_masuk.php" class="btn btn-danger btn-md" style="margin-right:5px;">Kembali</a>
				<input type="submit" name="submit" value="Terima" class="btn btn-success btn-md">
			</td>
